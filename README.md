...
No Higgsfield media is used anywhere. Stills are generated by this app; motion on the marketing pages and in simulated renders is Mixkit free-license stock footage (free for commercial use, no attribution required) served from Mixkit's CDN — see `src/lib/catalog/clips.ts`.
